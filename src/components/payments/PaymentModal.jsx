...
import { Calendar as CalendarIcon, DollarSign, CreditCard, Send, HelpCircle, User, Search, Tag } from 'lucide-react';
...
const PaymentModal = ({ isOpen, onClose, onSave, isManual = false, prefillData = {}, clients = [] }) => {
    ...
    return (
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="sm:max-w-lg top-12 left-[40%]">
                <DialogHeader>
