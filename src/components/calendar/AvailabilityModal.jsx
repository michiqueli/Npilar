        ...
        <Dialog open={isOpen} onOpenChange={onClose}>
            <DialogContent className="max-w-5xl top-12 left-[5%] md:left-[10%] lg:left-[20%] xl:left-[30%] " style={{ maxWidth: '40rem' }}>
                ...
                <Tabs value={tab} onValueChange={setTab} className="mt-4">
                        ...
                        {weekDays.map(({ key, label }) => {
                            ...
                            return (
                                <div key={key} className="p-4 rounded-lg bg-muted/50">
                                    ...
                                    {dayConfig.available && (
                                        <div className="mt-4 pl-0 sm:pl-8 grid grid-cols-1 md:grid-col-2 gap-x-8 gap-y-4">
                    ...
                    <TabsContent value="exceptions" className="mt-4 grid grid-cols-1 md:grid-cols-2 gap-6 center-content">
                        <div>
