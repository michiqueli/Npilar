...
import { Calendar as CalendarIcon, DollarSign, CreditCard, Send, HelpCircle, MinusCircle } from 'lucide-react';
...
const ExpenseForm = ({ onSave, onClose, transaction }) => {
    ...
    const [formData, setFormData] = useState({
        ...
        amount: '',
        category: 'Productos',
        paymentMethod: 'Efectivo', // <-- Añadido
        notes: '',
    });
    ...
    useEffect(() => {
        if (transaction) {
            setFormData({
                ...
                paymentMethod: transaction.paymentMethod || 'Efectivo', // <-- Añadido
    ...
    return (
        <DialogContent className="sm:max-w-lg top-12 sm:left-[20%] left-[5%] fixed xl:top-12 xl:left-[35%]">
            ...
            <form onSubmit={handleSubmit} className="space-y-4 md:space-y-6 py-4">
                ...
                {/* --- SECCIÓN DE MÉTODO DE PAGO RESTAURADA --- */}
                <div>
                ...
                <div>
                    ...
                    <Textarea
                        ...
                        placeholder="Añade detalles adicionales sobre el gasto..."
                        className="mt-1"
                    />
                </div>
                ...
                <DialogFooter>
                    ...
                    <Button type="submit" className="w-full sm:w-auto">
                        ...
                        {transaction ? 'Guardar Cambios' : 'Confirmar Gasto'}
                    </Button>
                </DialogFooter>
            </form>
        </DialogContent>
