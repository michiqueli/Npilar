...
import { Menu, User, Search, LogOut, Fingerprint } from "lucide-react"; // 1. Importamos el icono Fingerprint
...
const Header = ({ toggleSidebar, isMobile }) => {
  ...
  // 2. Obtenemos la función webAuthnRegister del contexto
        ...
        <div className="flex items-center space-x-3">
          ...
          <DropdownMenu>
            ...
            <DropdownMenuContent align="end" className="w-56">
              ...
              {/* --- 3. AÑADIMOS EL NUEVO BOTÓN AQUÍ --- */}
              <DropdownMenuItem onClick={webAuthnRegister}>
                <Fingerprint className="mr-2 h-4 w-4" />
                <div>
                  <p>Asociar Dispositivo</p>
